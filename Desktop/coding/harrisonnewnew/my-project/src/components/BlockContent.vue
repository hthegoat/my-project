...
<style scoped>
h1 {
  @apply text-3xl leading-none m-5;
}
h2 {
  @apply text-2xl leading-tight m-5;
}
h3 {
  @apply text-xl leading-tight m-5 p-5;
}
h4 {
...
blockquote {
  @apply border-l-4 border-primary italic pl-4 m-8 text-lg text-gray;
}
...
p {
  @apply leading-relaxed text-base m-8;
}
